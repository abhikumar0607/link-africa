...
class ExportAllClient implements FromCollection,WithHeadings,ShouldAutoSize,WithColumnFormatting
{
    /**
    ...
    */
    ...
    {
        $allResults = SiteMasterFile::orderBy('id','DESC')->whereNotIn('project_status', ['Q) Cancelled','T) Complete','U) Terminated'])->with('planning_record','permission_record','build_record','landlord_record','site_survey_record')->get()->toArray();
