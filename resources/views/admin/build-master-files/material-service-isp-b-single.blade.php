          ...
          <div class="col-md-12">
              <div class="card La-add-scroll">
                  <div class="card-header">
                      <h3 class="card-title">Edit Material Service Isp B</h3>
                  ...
                  <form action="{{ route('admin.planning.material.ispb.update',$record[0]['circuit_id'])}}" method="POST" enctype="multipart/form-data" id="add_site_survey_file_record" class="edit_site_master_file_record"> 
                  {{ csrf_field() }} 
                  @else
                      ...
                      <div class="row border-box" style="margin-top:10px; margin-bottom:10px;">
                          ...
                          <div class="col-3">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="labour_cost_vo_isp_b" value="{{ $record[0]['planning_record']['labour_cost_vo_isp_b'] }}" id="labour_cost_vo_isp_b" class="form-control qty7">
                            </div>
                        </div> 
                        ...
                        <div class="col-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="labour_cost_isp_b" value="{{ $record[0]['planning_record']['labour_cost_isp_b'] }}" id="labour_cost_isp_b" class="form-control qty8">
                                </div>
                            </div>
                        <div class="col-3">
                            <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="material_cost_vo_isp_b" value="{{ $record[0]['planning_record']['material_cost_vo_isp_b'] }}" id="material_cost_vo_isp_b" class="form-control qty7">
                        </div>
                    </div>
                        <div class="col-3">
                            <div class="form-group">
                                <label>Material Cost ISP B:</label>
                                <input type="text" name="material_cost_isp_b" value="{{ $record[0]['planning_record']['material_cost_isp_b'] }}" id="material_cost_isp_b" class="form-control qty8">
                            </div>
                        </div>
                    ...
                    <div class="col-3">
                        ...
                        <div class="col-3">
                            <div class="form-group">
                                ...
                                <input type="text" name="total_boq_value_vo_isp_b" value="{{ $record[0]['planning_record']['total_boq_value_vo_isp_b'] }}" id="total_boq_value_vo_isp_b" class="form-control block-field total7">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="total_boq_value_isp_b" value="{{ $record[0]['planning_record']['total_boq_value_isp_b'] }}" id="total_boq_value_isp_b" class="form-control total8 block-field">
                            </div>
                        </div> 
                        ...
                        <div class="col-3">
                          ...
                          <div class="row border-box">
                           ...
                           <div class="col-3">
                            <div class="form-group">
                                ...
                                <input type="text" name="isp_b_distance_trench" value="{{ $record[0]['planning_record']['isp_b_distance_trench'] }}" id="isp_b_distance_trench" class="form-control qty2">
                            </div>
                          </div>
                          <div class="col-3">
                            <div class="form-group">
                                <label>ISP B DISTANCE 3RD PARTY DUCTS:</label>
                                <input type="text" name="isp_b_distance_3rd_party_ducts" value="{{ $record[0]['planning_record']['isp_b_distance_3rd_party_ducts'] }}" id="isp_b_distance_3rd_party_ducts" class="form-control qty2">
                            </div>
                           </div>
                          </div>
                          <div class="col-md-3 inner-peth">
                          <div class="col-3">
                            <div class="form-group">
                                ...
                                <input type="text" name="isp_b_la_existing_duct" value="{{ $record[0]['planning_record']['isp_b_la_existing_duct'] }}" id="isp_b_la_existing_duct" class="form-control qty2">
                            </div>
                        </div>
                        <div class="col-3">
                                <div class="form-group">
                                    <label>ISP B LA EXISTING NETWORK:</label>
                                    <input type="text" name="isp_b_la_existing_network" value="{{ $record[0]['planning_record']['isp_b_la_existing_network'] }}" id="isp_b_la_existing_network" class="form-control qty2">
                                </div>
                            </div>
                         </div>
                         <div class="col-md-3 inner-peth">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="isp_b_distance_focus" value="{{ $record[0]['planning_record']['isp_b_distance_focus'] }}" id="isp_b_distance_focus" class="form-control qty2">
                            </div>
                        </div>
                        <div class="col-3">
                                <div class="form-group">
                                    <label>ISP B IN - BUILDIN CONDUITS:</label>
                                    <input type="text" name="isp_b_in_buildin_conduits" value="{{ $record[0]['planning_record']['isp_b_in_buildin_conduits'] }}" id="isp_b_in_buildin_conduits" class="form-control qty2">
                                </div>
                            </div>
                          </div>
                            <div class="col-md-3 inner-peth">
                      ...
                      <div class="material-header border-box">
                        <h2>Material Req ISP B Header</h2>
                        <button type="button" class="btn btn-primary add_new_planning_material_price" data-servive_id="{{ $record[0]['circuit_id'] }}" data-material_page_type="isp_b">Add New Material Price</button>
                        <table class="table-bordered table-striped">
                            ...
                            @foreach($record[0]['planning_isp_b_records'] as $planning_isp_b_record)
                                @php
                                    $list_price = 0;
                                    $planning_material_stock_code = "";
                                    $planning_material_id = "";
                                    if($planning_isp_b_record['planning_material_record']){
                                        $planning_material_id = $planning_isp_b_record['planning_material_record']['id'];
                                        $list_price = $planning_isp_b_record['planning_material_record']['list_price']; 
                                        $planning_material_stock_code = $planning_isp_b_record['planning_material_record']['stock_code'];
                                    }
                                    ...
                                    $quantity = 1;
                                    if($planning_isp_b_record['quantity'] != 0){
                                        $quantity = $planning_isp_b_record['quantity'];
                                    }
                                ...
                                <tr class="material_price_list">
                                    <td>{{ $planning_isp_b_record['circuit_id'] }}</td>
                                    <td>
                                    ...
                                    <td>
                                        <input type="text" name="isp_b_material_b_quantity[]" value="{{ $quantity }}" class="form-control material_quantity">
                                    </td>
                                    <td>
                                        <input type="text" name="isp_b_material_list_price[]" value="{{ $material_list_price }}" class="form-control material_list_price  block-field">
                                    </td>
                                    <td>
                                        <input type="text" name="isp_b_material_extended_price[]" value="{{ $material_extended_price }}" class="form-control material_extended_price  block-field">
                                    </td>
                                </tr>
                            @endforeach
                            </table>
                            ...
                            <div class="meterial-price-total">
                                Total:<input type="text" name="isp_b_material_total_price" value="{{ 'R '.$material_total_price; }}" class="form-control material_total_price block-field">
                            </div>
                      </div>
