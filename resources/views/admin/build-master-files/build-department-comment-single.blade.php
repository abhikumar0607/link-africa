          ...
          <div class="col-md-12">
              <div class="card La-add-scroll">
                  <div class="card-header">
                      <h3 class="card-title">Edit Build Department</h3>
                          ...
                          <div class="col-3">
                           ...
                           <div class="col-3">
                            <div class="form-group">
                                ...
                                <input type="text"  name="build_status" value="{{ $record[0]['build_status'] }}" id="build_status" class="form-control">
                            </div>
                          </div>
                          <div class="col-3">
                              <div class="form-group">
                                <label>SERVICE ID:</label>
                                <input type="text"   name="service_id" value="{{ $record[0]['service_id'] }}" id="service_id" class="form-control">
                                 <input type="hidden" name="circuit_id" value="{{ $record[0]['circuit_id'] }}" id="circuit_id" class="form-control">
                            </div>
                          </div>
                          <div class="col-3">
                            <div class="form-group">
                                <label>Client:</label>
                                <input type="text"  name="client_name" value="@if($record[0]['site_master_record']) {{ $record[0]['site_master_record']['client_name'] }} @endif" id="client_name" class="form-control block-field">
                            </div>
                          </div>
                            <div class="col-3">
                            <div class="form-group">
                                <label>Planning Status:</label>
                                <input type="text"   name="planning_status" value="@if($record[0]['planning_record']){{ $record[0]['planning_record']['planning_status'] }} @endif" id="planning_status" class="form-control block-field">
                            </div>
                          </div>
                             <div class="col-3">
                            <div class="form-group">
                                <label>SD Status:</label>
                                <input type="text"  name="sd_status" value="@if($record[0]['site_master_record']) {{ $record[0]['site_master_record']['service_delivery_status'] }} @endif" id="sd_status" class="form-control block-field">
                            </div>
                          </div>
                           <div class="col-3">
                            <div class="form-group">
                                <label>Metro Area:</label>
                                 <input type="text"  name="metro_area" value="@if($record[0]['site_master_record']) {{ $record[0]['site_master_record']['metro_area'] }} @endif" id="metro_area" class="form-control block-field">
                            </div>
                          </div>
                          <div class="col-3">
                            <div class="form-group">
                                <label>Type:</label>
                                <input type="text"  name="type" value="@if($record[0]['site_master_record']) {{ $record[0]['site_master_record']['type'] }} @endif" id="type" class="form-control block-field">
                            </div>
                          </div>
                          <div class="col-3">
                            <div class="form-group">
                                <label>Permission Status:</label>
                                <input type="text" name="permission_status" value="@if($record[0]['permission_record']){{ $record[0]['permission_record']['permissions_status'] }} @endif" id="permission_status" class="form-control block-field">
                            </div>
                          </div>
                           <div class="col-3">
                            <div class="form-group">
                                <label>Service Type:</label>
                                 <input type="text"  name="service_type" value="@if($record[0]['site_master_record']) {{ $record[0]['site_master_record']['service_type'] }} @endif" id="service_type" class="form-control block-field">
                            </div>
                          </div>
