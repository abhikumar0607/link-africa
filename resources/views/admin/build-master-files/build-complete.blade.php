              ...
              <div class="card-body La-scroll">
                ...
                <table class="table table-bordered table-striped">
                  ...
                  <tr class="sticky">
                    ...
                    <th>SITE B</th>
                    <th>ISP B TOTAL DISTNACE</th>
                    <th>BUILD COMPLETION(m)</th>
                  ...
                  <tbody>
                    @foreach($all_records as $record)
                        <tr>
                            <td><a href="{{ url('admin/build/build-complete-single',$record->id) }}">{{ $record->circuit_id }}</a></td>
                            ...
                            <td>@if($record->planning_record){{ $record->planning_record->isp_a_total_distance }} @endif</td>
                            <td>@if($record->site_master_record){{ $record->site_master_record->site_b }} @endif</td>
                            <td>@if($record->planning_record){{ $record->planning_record->isp_b_total_distance }} @endif</td>
