          ...
          <div class="col-md-12">
              <div class="card La-add-scroll">
                  <div class="card-header">
                    <h3 class="card-title">Edit Material Service Isp A</h3>
                      ...
                      <div class="card-body no-scroll-need">
                        <div class="row border-box" style="margin-top:10px; margin-bottom:10px;">
                          ...
                          <div class="col-3">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="labour_cost_vo_isp_a" value="{{ $record[0]['planning_record']['labour_cost_vo_isp_a'] }}" id="labour_cost_vo_isp_a" class="form-control qty7">
                            </div>
                        </div> 
                        ...
                        <div class="col-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="labour_cost_isp_a" value="{{ $record[0]['planning_record']['labour_cost_isp_a'] }}" id="labour_cost_isp_a" class="form-control qty8">
                                </div>
                            </div>
                        <div class="col-3">
                            <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="material_cost_vo_isp_a" value="{{ $record[0]['planning_record']['material_cost_vo_isp_a'] }}" id="material_cost_vo_isp_a" class="form-control qty7">
                        </div>
                    </div>
                        <div class="col-3">
                            <div class="form-group">
                                <label>Material Cost ISP A:</label>
                                <input type="text" name="material_cost_isp_a" value="{{ $record[0]['planning_record']['material_cost_isp_a'] }}" id="material_cost_isp_a" class="form-control qty8">
                            </div>
                        </div>
                    ...
                    <div class="col-3">
                        ...
                        <div class="col-3">
                            <div class="form-group">
                                ...
                                <input type="text" name="total_boq_value_vo_isp_a" value="{{ $record[0]['planning_record']['total_boq_value_vo_isp_a'] }}" id="total_boq_value_vo_isp_a" class="form-control block-field total7">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="total_boq_value_isp_a" value="{{ $record[0]['planning_record']['total_boq_value_isp_a'] }}" id="total_boq_value_isp_a" class="form-control total8 block-field">
                            </div>
                        </div> 
                        ...
                        <div class="col-3">
                          ...
                          <div class="row border-box">
                           ...
                           <div class="col-3">
                            <div class="form-group">
                                ...
                                <input type="text" name="isp_a_distance_trench" value="{{ $record[0]['planning_record']['isp_a_distance_trench'] }}" id="isp_a_distance_trench" class="form-control qty2">
                            </div>
                          </div>
                          <div class="col-3">
                            <div class="form-group">
                                <label>ISP A DISTANCE 3RD PARTY DUCTS:</label>
                                <input type="text" name="isp_a_distance_3rd_party_ducts" value="{{ $record[0]['planning_record']['isp_a_distance_3rd_party_ducts'] }}" id="isp_a_distance_3rd_party_ducts" class="form-control qty2">
                            </div>
                           </div>
                          </div>
                          <div class="col-md-3 inner-peth">
                          <div class="col-3">
                            <div class="form-group">
                                ...
                                <input type="text" name="isp_a_la_existing_duct" value="{{ $record[0]['planning_record']['isp_a_la_existing_duct'] }}" id="isp_a_la_existing_duct" class="form-control qty2">
                            </div>
                        </div>
                        <div class="col-3">
                                <div class="form-group">
                                    <label>ISP A LA EXISTING NETWORK:</label>
                                    <input type="text" name="isp_a_la_existing_network" value="{{ $record[0]['planning_record']['isp_a_la_existing_network'] }}" id="isp_a_la_existing_network" class="form-control qty2">
                                </div>
                            </div>
                         </div>
                         <div class="col-md-3 inner-peth">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="isp_a_distance_focus" value="{{ $record[0]['planning_record']['isp_a_distance_focus'] }}" id="isp_a_distance_focus" class="form-control qty2">
                            </div>
                        </div>
                        <div class="col-3">
                                <div class="form-group">
                                    <label>ISP A IN - BUILDIN CONDUITS:</label>
                                    <input type="text" name="isp_a_in_buildin_conduits" value="{{ $record[0]['planning_record']['isp_a_in_buildin_conduits'] }}" id="isp_a_in_buildin_conduits" class="form-control qty2">
                                </div>
                            </div>
                          </div>
                            <div class="col-md-3 inner-peth">
                            <div class="col-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="isp_a_total_distance" value="{{ $record[0]['planning_record']['isp_a_total_distance'] }}" id="isp_a_total_distance" class="form-control block-field total2">
                                </div>
                            </div>
                           </div>
                       </div>
