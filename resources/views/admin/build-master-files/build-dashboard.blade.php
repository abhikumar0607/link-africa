           ...
           <div class="col-md-3">
             <div class="project-ageing">
                ...
                <table>
                  ...
                  <tr>
                        <td><a href="{{ url('admin/build/home-project-ageing/120-days') }}">120 Days</a></td>
                        <td>{{ $one_twitty_sub_count; }}</td>
                  </tr>
                  <tr>
                        <td><a href="{{ url('admin/build/home-project-ageing/60-days') }}">60 Days</a></td>
                        <td>{{ $sixteen_sub_days_count; }}</td>
                  </tr>
                     <tr>
                        <td><a href="{{ url('admin/build/home-project-ageing/90-days') }}">90 Days</a></td>
                        <td>{{ $nintyeen_sub_days_count; }}</td>
                  </tr>
                  <tr>
                        <td><a href="{{ url('admin/build/home-project-ageing/current') }}">Current</a></td>
                        <td>{{ $current_date_count; }}</td>
                  </tr>
                  <tr>
                        <td><a href="{{ url('admin/build/home-project-ageing/more-than-120') }}">More than 120</a></td>
             ...
             <div class="col-md-2">
             <div class="project-ageing">
                <h2>BUILD TOC STATUS</h2>
                 <table>
                   <tr>    
                     <td><a href="{{ url('admin/build/home-build-toc-status/no') }}">No</a></td>
                     <td>{{ $count_build_toc_status_no; }}</td>
                  </tr>
                  <tr>    
                     <td><a href="{{ url('admin/build/home-build-toc-status/yes') }}">Yes</a></td>
                     <td>{{ $count_build_toc_status_yes; }}</td>
                  </tr>
                </table>  
             </div> 
          </div>
