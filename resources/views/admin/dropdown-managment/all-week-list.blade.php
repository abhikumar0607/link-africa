                  ...
                  <tbody>
                    ...
                    @foreach($all_records as $records)
                        ...
                        @if(in_array('all', $edit_access['edit_access_type']))  
                           <td><a href="{{ url('admin/week/delete',$records->id) }}">Delete</a></td>
                        @else
        ...
        <div class="modal-dialog">
          <div class="modal-content">
            <div class="modal-header">
              <h4 class="modal-title">Add Week Name</h4>
            ...
            @php $edit_access =  Helper::manage_edit_pages_access();  @endphp
            @if(in_array('all', $edit_access['edit_access_type']))
               <form method="POST" action="{{ url('admin/week/submit') }}" enctype="multipart/form-data">
            @csrf
            @else
                <form method="POST" action="#" enctype="multipart/form-data">
            @endif 
                <div class="form-group">
                  <label for="service_name">Week</label>
