    ...
    <section class="content-header">
      <div class="container-fluid">
        ...
        @include('admin.customer.customer-admin-header')
            ...
            <div class="col-md-6">
            <form class="search" action="{{url('admin/search-customer-record')}}" method="GET" role="search">
                ...
                <table class="table table-bordered table-striped" >
                  ...
                  <tbody>
                    @foreach($all_records as $record)
                        <tr>
                        <td><a href="{{ url('admin/single-customer-view',$record->id ) }}">{{ $record->service_id }}</a></td>
