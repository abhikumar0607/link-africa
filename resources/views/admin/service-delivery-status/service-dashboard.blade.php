            ...
            <div class="col-md-3">
               <div class="project-ageing">
                  ...
                  <table>
                     ...
                     <tr>
                        <td><a href="{{ url('admin/service-delivery/home-project-ageing/current') }}">Current Date</a></td>
                        <td>{{ $current_date_count; }}</td>
                     </tr>
                     <tr>
                        <td><a href="{{ url('admin/service-delivery/home-project-ageing/60-days') }}">60 days</a></td>
                        <td>{{ $sixteen_sub_days_count; }}</td>
                     </tr>
                     <tr>
                        <td><a href="{{ url('admin/service-delivery/home-project-ageing/90-days') }}">90 days</a></td>
                        <td>{{ $nintyeen_sub_days_count; }}</td>
                     </tr>
                     <tr>
                        <td><a href="{{ url('admin/service-delivery/home-project-ageing/120-days') }}">120 days</a></td>
                        <td>{{ $one_twitty_sub_count; }}</td>
                     </tr>
                     <tr>
                        <td><a href="{{ url('admin/service-delivery/home-project-ageing/more-120-days') }}">More than 120 days</a></td>
