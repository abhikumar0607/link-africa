    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
               ...
               <div class="col-md-3">
                 <form class="search" action="{{url('admin/planning/search/landlord')}}" method="GET" role="search">
              ...
              <div class="card-body La-scroll">
                ...
                <table class="table table-bordered table-striped">
                  ...
                  <tr class="sticky">
                    ...
                    <th>BUILD STATUS</th>
                    <th>TYPE</th>
                    <th>LAND LORD APPROVAL STATUS</th>
                  ...
                  <tbody>
                    @foreach($all_records as $record)
                        <tr>
                            <td><a href="{{ url('admin/planning/landlord-approval',$record->id) }}">{{ $record->service_id }}</a></td>
