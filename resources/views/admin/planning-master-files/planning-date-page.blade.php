              ...
              <div class="card-body La-scroll">
                ...
                <table class="table table-bordered table-striped">
                  ...
                  <tr class="sticky">
                    ...
                    <th>FEASIBILITY REF NR</th>
                  </tr>
                  </thead>
                  <tbody>
                    @foreach($all_records as $record)
                        <tr>
                            <td><a href="{{ url('admin/planning/planning-dates',$record->id) }}">{{ $record->service_id }}</a></td>
                            ...
                            <td>@if($record->feasibility_ref_nr){{ $record->site_master_record->feasibility_ref_nr }} @endif</td>
                        </tr>
                    @endforeach
                  </tbody>
                </table>
