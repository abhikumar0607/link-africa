@extends('admin.layouts.master')
 @section('content')
        ...
        <div class="row">
          ...
          <div class="col-md-12">
              <div class="card La-add-scroll">
                  ...
                  @if(count($record) >= 1)
                  @php $edit_access =  Helper::manage_edit_pages_access(); 
                   @endphp
                        ...
                        <div class="col-4 listing-design-link">
                            <div class="form-group">
                              ...
                              @if(count($record[0]['attachment_record']) > 0) 
                                ...
                                @if($attachment['page_type'] == 'planning')
                          ...
                          <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#planning_model">
                           Upload Attachment
                          </button>
                            </div>
                          ...
                          <div class="col-3">
                            <div class="form-group">
                                ...
                                <input type="hidden" value="{{ $record[0]['is_email_sent'] }}" class="form-control" name="is_email_sent" id="is_email_sent">
                                <input type="hidden" value="{{ $record[0]['region'] }}" class="form-control" name="region" id="region">
                ...
                <div class="form-group">
                    ...
                    <select class="form-control" name="planning_status" id="planning_status">
                        ...
                        @endforeach
                          ...
                          <div class="col-4">
                            <div class="form-group">
                              <label>Financial Approval Date:</label> 
                              @if($record[0]['financial_approved_date'])
                              <input type="text" value="{{ Carbon\Carbon::parse($record[0]['financial_approved_date'])->format('m/d/Y') }}" class="form-control block-field" name="financial_approved_date" id="financial_approved_date">
                               @else
                               <input type="text" value="" class="form-control block-field" name="financial_approved_date" id="financial_approved_date">
                              @endif 
                            </div>
                            </div>
                          </div>
                ...
                <div class="form-group">
                  ...
                  <div class="input-group date" id="custom_date_picker19" data-target-input="nearest">
                    @if( $record[0]['permission_record']['wayleaves_submitted'])
                      <input type="text" class="form-control block-field"   value="{{ Carbon\Carbon::parse($record[0]['permission_record']['wayleaves_submitted'])->format('m/d/Y') }}">
                      @else
                      <input type="text" class="form-control block-field"   value="">
                    @endif
                  </div>
                </div>
              </div>  
              <div class="col-3">
                <div class="form-group">
                  ...
                  @if($exepected_wl_received_date)
                      <input type="text" value="{{ $exepected_wl_received_date }}" name="" id="exepected_wl_received_date" class="form-control block-field"/>
                      @else
                ...
                <div class="form-group">
                  <label>WAYLEAVES RECEIVED:</label>
                    @if($record[0]['permission_record']['wayleaves_received'])
                      <input type="text" class="form-control block-field" name="" id="wayleaves_received"  value="{{ Carbon\Carbon::parse($record[0]['permission_record']['wayleaves_received'])->format('m/d/Y') }}">
                      @else
                      <input type="text" class="form-control block-field" name="" id="wayleaves_received"  value="">
                      @endif
  ...
  <!-- /.content-wrapper -->
  <!-- Modal -->
  <div class="modal fade" id="planning_model" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                          <div class="modal-dialog sale-attachment">
                            <div class="modal-content">
                              <div class="modal-header">
                                <h5 class="modal-title" id="exampleModalLabel">Planning Attachment</h5>
                              ...
                              <div class="modal-body">
                                ...
                                <div class="upload-icon">
                                  ...
                                  <input type="hidden" id="service_id" name="service_id" value ="{{ $record[0]['site_master_record']['circuit_id'] }}">
                                  <input type="hidden" id="circuit_id" name="circuit_id" value = "{{ $record[0]['site_master_record']['circuit_id'] }}">
                                  <input type="hidden" id="page_type" name="sales" value ="planning">
                                  </div>
                                  <div id="selectedFiles"></div>
                                  <label>Select Type</label>
                                  <select class="form-control" id="form_type" name="form_type">
                                    <option value ="">Please Select</option>
                                    <option value ="ISP Plans">ISP Plans</option>
                                    <option value ="OSP Plans">OSP Plans</option>
                                    <option value ="Splicing Instruction">Splicing Instruction</option>
