@extends('admin.layouts.master')
 @section('content')
    ...
    <?php
   // echo  "<pre>"; print_r($site_survey_record); exit;?>
    <!-- Main content -->
          ...
          <div class="col-md-12">
              <div class="card La-add-scroll">
                  <div class="card-header">
                      <h3 class="card-title">Edit Site Survey Status</h3>
                  ...
                  @if(in_array('all', $edit_access['edit_access_type']) OR in_array('planning', $edit_access['edit_access_type']))
                    <form action="{{ route('admin.planning.site.survey.update' ,$record[0]['id']) }}" method="POST" enctype="multipart/form-data" id="add_site_master_file_records" class="edit_site_master_file_record"> 
                    {{ csrf_field() }} 
                  @else
                          ...
                          <div class="col-2">
                            ...
                            <div class="col-2">
                              <div class="form-group">
                                ...
                                <input type="hidden" class="form-control block-field" name="service_id" id="service_id" value="{{ $record[0]['site_master_record']['service_id'] }}">
                ...
                <div class="form-group">
                    <label>planning_status:</label>
                        <input type="text" name="planning_status" value="{{ $record[0]['planning_status'] }}" id="planning_status" class="form-control block-field">
                </div>
              </div>
                        <div class="col-2">
                            <div class="form-group">
                         ...
                         <input type="text" name="client_name" value="{{ $record[0]['site_master_record']['client_name'] }}" id="client_name" class="form-control block-field">
                          ...
                          <div class="col-6">
                            <div class="form-group">
                                ...
                                <select class="form-control" name="site_survey_status" id="site_survey_status">
                                <option value="" selected="">Please Select</option>
                                @if($record[0]['site_survey_record'])
                                  @foreach($all_site_survey_status as $site_survey_status)
                                   <option value="{{ $site_survey_status->site_survey_status }}" <?php if($record[0]['site_survey_record']['site_survey_status'] == $site_survey_status->site_survey_status){echo 'selected';}?>>{{ $site_survey_status->site_survey_status }}</option>
                                  @endforeach 
                                @else
                                  @foreach($all_site_survey_status as $site_survey_status)
                                   <option value="{{ $site_survey_status->site_survey_status }}">{{ $site_survey_status->site_survey_status }}</option>
                                  @endforeach 
                                @endif
                                </select>
                            </div>
                      ...
                      <div class="col-3">
                        <div class="form-group">
                          ...
                          <div class="col-3">
                              <div class="form-group">
                                <label>Date Recived From Site B:</label>
                                <div class="input-group date" id="custom_date_picker5" data-target-input="nearest"> 
                                @if($record[0]['site_survey_record'])
                                    <input type="text" class="form-control datetimepicker-input" name="survey_date_received_from" id="survey_date_received_from" data-target="#custom_date_picker5" value="{{ $record[0]['site_survey_record']['survey_date_received_from'] }}">
                                    @else
                                <input type="text" class="form-control datetimepicker-input" name="survey_date_received_from" id="survey_date_received_from" data-target="#custom_date_picker5" value="">
                                @endif
                            ...
                            <div class="col-3">
                              <div class="form-group">
                                <label>Date Site B Survey:</label>
                                <div class="input-group date" id="custom_date_picker6" data-target-input="nearest">
                                @if($record[0]['site_survey_record'])
                                    <input type="text" class="form-control datetimepicker-input" name="date_site_survey" id="date_site_survey" data-target="#custom_date_picker6" value="{{ $record[0]['site_survey_record']['date_site_survey'] }}">
                                    @else
                                <input type="text" class="form-control datetimepicker-input" name="date_site_survey" id="date_site_survey" data-target="#custom_date_picker6" value="">
                                @endif
                            ...
                            <div class="col-3">
                              <div class="form-group">
                                ...
                                @if($record[0]['site_survey_record'])
                                    <input type="text" class="form-control datetimepicker-input" name="survey_date_on_hold" id="survey_date_on_hold" data-target="#custom_date_picker7" value="{{ $record[0]['site_survey_record']['survey_date_on_hold'] }}">
                                    @else
                                <input type="text" class="form-control datetimepicker-input" name="survey_date_on_hold" id="survey_date_on_hold" data-target="#custom_date_picker7" value="">
                                @endif
                            ...
                            <div class="col-3">
                              <div class="form-group">
                                <label>Date Recived From Site A:</label>
                                <div class="input-group date" id="custom_date_picker11" data-target-input="nearest">
                                @if($record[0]['site_survey_record'])
                                    <input type="text" class="form-control datetimepicker-input" name="survey_date_received_from_site_a" id="survey_date_received_from_site_a" data-target="#custom_date_picker11" value="{{ $record[0]['site_survey_record']['survey_date_received_from_site_a'] }}">
                                    @else
                                <input type="text" class="form-control datetimepicker-input" name="survey_date_received_from_site_a" id="survey_date_received_from_site_a" data-target="#custom_date_picker11" value="">
                                @endif
                            ...
                            <div class="col-3">
                              <div class="form-group">
                                <label>Date Site A Survey:</label>
                                <div class="input-group date" id="custom_date_picker12" data-target-input="nearest">
                                @if($record[0]['site_survey_record'])
                                    <input type="text" class="form-control datetimepicker-input" name="date_site_survey_a" id="date_site_survey_a" data-target="#custom_date_picker12" value="{{ $record[0]['site_survey_record']['date_site_survey_a'] }}">
                                    @else
                                <input type="text" class="form-control datetimepicker-input" name="date_site_survey_a" id="date_site_survey_a" data-target="#custom_date_picker12" value="">
                                @endif
                            ...
                            <div class="col-3">
                              <div class="form-group">
                                ...
                                @if($record[0]['site_survey_record'])
                                    <input type="text" class="form-control datetimepicker-input" name="survey_date_on_hold_site_a" id="survey_date_on_hold_site_a" data-target="#custom_date_picker13" value="{{ $record[0]['site_survey_record']['survey_date_on_hold_site_a'] }}">
                                    @else
                                <input type="text" class="form-control datetimepicker-input" name="survey_date_on_hold_site_a" id="survey_date_on_hold_site_a" data-target="#custom_date_picker13" value="">
                                @endif
                          ...
                          <div class="row">
                            <div class="col-12">
                            <label for="w3review">Comment:</label><textarea id="w3review1" name="Comment"  cols="120" style="width:100%">{{ $record[0]['comment'] }}</textarea>
                            </div>
                          </div>
                        </div>
                      </div>
