    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
               ...
               <div class="col-md-3">
                 <form class="search" action="{{url('admin/planning/search/material/isp/a')}}" method="GET" role="search">
                ...
                <table class="table table-bordered table-striped">
                  ...
                  <tbody>
                    @foreach($all_records as $record)
                        <tr>
                            <td><a href="{{ url('admin/planning/planning-material-service-isp-a',$record->id) }}">{{ $record->service_id }}</a></td>
