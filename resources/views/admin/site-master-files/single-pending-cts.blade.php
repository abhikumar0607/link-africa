          ...
          <div class="col-md-12">
              <div class="card La-add-scroll">
                  <div class="card-header">
                      <h3 class="card-title">Edit Pending CTS</h3>
                   ...
                   @php $edit_access =  Helper::manage_edit_pages_access();  @endphp
                    ...
                    <form action="{{ route('admin.sale.pending.update-record', $record[0]['id'])}}" method="POST" enctype="multipart/form-data" id="add_site_master_file_record" class="edit_site_master_file_record"> 
                    {{ csrf_field() }} 
                  @else
                        ...
                        <div class="col-2">
                            ...
                            <div class="form-group">
                              <label>Date New:</label>
                                <div class="input-group date" id="custom_date_picker" data-target-input="nearest">
                                  <?php 
                                  $status = 'V) Pending CTS'; ?>
                                  @if($record[0]['project_status'] == $status)
                                    <input type="text" class="form-control" name="date_new" id="date_new" value="">
                                  @else
                          ...
                          <div class="col-2">
                              <div class="form-group">
                                ...
                                <input type="hidden" name="cts_date" value="{{ $record[0]['cts_date'] }}" id="cts_date" class="form-control">
                            </div>
                          </div>
                          <div class="col-2">
                            <div class="form-group">
                                ...
                                <select class="form-control" name="service_type" id="service_type">
                                  <option value=""></option>
                                    @foreach($all_service_types as $service_type)
                                        <option value="{{ $service_type['service_name'] }}" {{ ( $service_type['service_name'] == $record[0]['service_type']) ? 'selected' : '' }}> {{ $service_type['service_name'] }} </option>
                                    @endforeach
                          ...
                          <div class="col-2">
                            <div class="form-group">
                                ...
                                <select class="form-control" name="project_status" id="project_status">
                                  <option data-id="{{ Carbon\Carbon::now()->format('m/d/Y'); }}" value="A) New Sales"<?php if ($record[0]['project_status'] == 'A) New Sales') echo ' selected="selected"'; ?>>A) New Sales</option>
