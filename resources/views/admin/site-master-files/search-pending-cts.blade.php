    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
            ...
            <div class="col-md-4">
            <form class="search" action="{{ url('admin/search-pending-cts') }}" method="GET" role="search">
                ...
                <table class="table table-bordered table-striped" >
                  ...
                  <tbody>
                    @foreach($all_records as $record)
                        <tr>
                            <td><a href="{{ url('admin/sale/single-pending-cts',$record->id) }}">{{ $record->circuit_id }}</a></td>
                            ...
                            <td>@if($record->cts_date) {{ Carbon\Carbon::parse($record->cts_date)->format('m/d/Y') }} @endif</td>
                            <td>{{ $record->site_a }}</td>
                            <td>{{ $record->site_b }}</td>
