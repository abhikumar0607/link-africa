        ...
        <div class="col-md-6">
          <div class="card card-primary service-add">
                ...
                @if(in_array('all', $edit_access['edit_access_type']))
                  <form method="GET" action="" id="password_reset_form" enctype="multipart/form-data">
                  @csrf
                @else
               ...
               <div class="form-group">
                  ...
                  <input type="hidden" name="update_request_type" value="is_email_check" id="update_request_type">
               </div>
              <div class="password_field_res"></div>
              
                <div class="row">
                  <div class="col-12"> 
                  @if(in_array('all', $edit_access['edit_access_type']))
                      <input type="submit" value="Submit" class="btn btn-success">
                      <div class="update_password_res"></div>
                  @endif
                  </div>
                </div>
              </form>
