          ...
          <div class="col-md-12">
              <div class="card La-add-scroll">
                  <div class="card-header">
                      <h3 class="card-title">Edit Permission Department</h3>
                        ...
                        <div class="row free-Qwe">
                          ...
                          <div class="col-3">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="planning_status" value="@if($record[0]['site_master_record']){{ $record[0]['planning_record']['planning_status'] }} @endif" id="planning_status" class="form-control">
                            </div>
                          </div>
                             <div class="col-3">
                            <div class="form-group">
                          ...
                          <div class="col-3">
                            <div class="form-group">
                                ...
                                <input type="text" name="permission_status" value="{{ $record[0]['permissions_status'] }}" id="permission_status" class="form-control">
                            </div>
                          </div>
                           <div class="col-3">
                            <div class="form-group">
                          ...
                          <div class="row thrd-Qw">
                           <div class="col-md-3">
                             ...
                             <textarea id="w3review" name="planning_comment">@if($record[0]['department_comments']) {{ $record[0]['department_comments']['planning_comment'] }}@endif</textarea>  
                          </div>
                          <div class="col-md-3">
                               <h2>Permission Comments</h2>
                               <textarea id="w3review" name="permission_comment">@if($record[0]['department_comments']) {{ $record[0]['department_comments']['permission_comment'] }}@endif</textarea> 
                          </div>
                          <div class="col-md-3">
                              <h2>Build Comments</h2>
                               <textarea id="w3review" name="build_comment">@if($record[0]['department_comments']) {{ $record[0]['department_comments']['build_comment'] }}@endif</textarea> 
                          </div>
                           <div class="col-md-3">
                               <h2>Service Delivery Comments</h2>
                               <textarea id="w3review" name="service_delivery_comment">@if($record[0]['department_comments']) {{ $record[0]['department_comments']['service_delivery_comment'] }}@endif</textarea> 
                          </div>
                        </div>
                      </div>
