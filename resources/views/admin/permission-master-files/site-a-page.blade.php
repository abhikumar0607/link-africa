                ...
                <table class="table table-bordered table-striped">
                  ...
                  <tbody>
                    @foreach($all_records as $record)
                        <tr>
                            <td><a href="{{ url('admin/permission/permission-site-a-single',$record->id) }}">{{ $record->circuit_id }}</a></td>
                            ...
                            <td>{{ $record->site_a_lla_submitted }}</td>
                            <td>{{ $record->site_a_lla_estimated }}</td>
                            <td>{{ $record->site_a_lla_received }}</td>
                             <td></td>
