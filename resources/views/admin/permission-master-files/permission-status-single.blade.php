          ...
          <div class="col-md-12">
              <div class="card La-add-scroll">
                  <div class="card-header">
                      <h3 class="card-title">Edit Permission Status</h3>
                        ...
                        <div class="col-4 listing-design-link">
                            <div class="form-group">
                              ...
                              @if(count($record[0]['attachment_record']) > 0) 
                                ...
                                @if($attachment['page_type'] == 'permission')
                          ...
                          <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#permission_modal">
                           Upload Attachment
                          </button>
                            </div>
                          ...
                          <div class="modal-dialog sale-attachment">
                            <div class="modal-content">
                              <div class="modal-header">
                                <h5 class="modal-title" id="exampleModalLabel">Permission Attachment</h5>
                              ...
                              <div class="modal-body">
                                ...
                                <div class="upload-icon">
                                  ...
                                  <input type="hidden" id="page_type" name="sales" value ="permission">
                                  </div>
                                  <div id="selectedFiles"></div>
                                  <label>Select Type</label>
                                  <select class="form-control" id="form_type" name="form_type">
                                  <option value ="">Please Select</option>
                                    <option value ="Wayleaves maps">Wayleaves maps</option>
                                    <option value ="Approval Permission">Approval Permission</option>
                                    <option value ="Wayleaves Response">Wayleaves Response</option>
