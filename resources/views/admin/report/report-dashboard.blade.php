  ...
  <div class="col-sm-12"> <!--content-wrapper-->
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
            @include('admin.report.report-header')
            </div>
      </div><!-- /.container-fluid -->
    </section>
    <!---project-Content--->
          ...
          <div class="col-md-4">
            <div class="project-ageing">
                <h2>Project Ageing</h2>
                 ...
                 <tr>
                     <td><a href="{{url('admin/sale/all-list')}}">Current Date</a></td>
                     <td>{{ $current_date_count; }}</td>
                 </tr>
                 <tr>
                     <td><a href="{{url('admin/sale/all-list')}}">60 days</a></td>
                     <td>{{ $sixteen_sub_days_count; }}</td>
                 </tr>
                  <tr>
                     <td><a href="{{url('admin/sale/all-list')}}">90 days</a></td>
                     <td>{{ $nintyeen_sub_days_count; }}</td>
                 </tr>
                 <tr>
                     <td><a href="{{url('admin/sale/all-list')}}">120 days</a></td>
                     <td>{{ $one_twitty_sub_count; }}</td>
                 </tr>
                 <tr>
                     <td><a href="{{url('admin/sale/all-list')}}">More than 120 days</a></td>
                     <td>{{ $more_then_one_twitty_sub_days_count; }}</td>
                 </tr>
                 <!--<tr>
                     <td><a href="{{url('admin/sale/all-list')}}">Query</a></td>
                     <td>4</td>
                 </tr>-->
                </table>
              </div>
